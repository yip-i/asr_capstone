...
import datasets
import torch
from datasets import DatasetDict, concatenate_datasets, load_dataset, Audio
...
def main():
    ...
    datasets_splits = load_dataset('csv', data_files='/content/uaspeech_audio_file_list.csv')
    ...
    # else:
    raw_datasets["train"] = datasets_splits['train']
    raw_datasets.cast_column("audio", Audio(sampling_rate=16_000))
